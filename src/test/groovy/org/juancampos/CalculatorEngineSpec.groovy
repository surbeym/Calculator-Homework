...
class CalculatorEngineSpec extends Specification {
    ...
    def "Test resolve variable "() {
        ...
        def actualCounter = CalculatorEngine.resolveVariableName(inputString,numberStack,variablesMap,0 as int ,inputCharacter as char)
        ...
        "FOO"         | 'F' as char    | [1L] as Stack<Long>     |[]                      || 2               | 1               | true
